...
/**
 * @brief WhitelineFilter::findLines This function finds the white lines in the src_image
 ...
 */
void WhitelineFilter::findLines( const cv::Mat &src_image)
{
    ...
    if ( this->h_rho <= 0 ){this->h_rho = 1;}
    if ( this->h_theta <= 0 ){this->h_theta = 1;}
    if ( this->h_thresh <= 0 ){this->h_thresh = 1;}
    ...
    {
        line( this->hough_image, cv::Point( lines[i][0], lines[i][1] ), cv::Point( lines[i][2], lines[i][3] ), cv::Scalar( 255, 255, 255 ), 3, 8 );
        line( this->cyan_image, cv::Point( lines[i][0], lines[i][1] ), cv::Point( lines[i][2], lines[i][3] ), cv::Scalar( 255, 255, 0 ), 5, 8 );
    }
}

/**
 * @brief whiteline_filter::findPointsOnLines. Finds the x,y coordinates of each point on line defined by an start and end point.
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Original image in a window
 *
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Grayscale image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Blurred image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Threshold image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Eroded image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Canny Edge image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Hough Lines image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
...
/**
 * @brief whiteline_filter::displayOriginal Use OpenCV imShow to display the Cyan Lined image in a window
 *
 * This function reduces the size of the picture to 400x300
 */
